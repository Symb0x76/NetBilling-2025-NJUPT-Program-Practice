    ...
    : ElaWindow(parent)
{
    ...
    m_dataDir = QDir::current().filePath(QStringLiteral(u"data"));
...
void MainWindow::setupUi()
{
    ...
    setUserInfoCardTitle(QStringLiteral(u"NetBilling"));
    setUserInfoCardSubTitle(QStringLiteral(u"校园/企业上网计费助手"));
}
...
void MainWindow::handleCreateUser()
{
    ...
    if (exists)
    {
        QMessageBox::warning(this, windowTitle(), QStringLiteral(u"账号已存在，请使用唯一编号。"));
        return;
    }
...
void MainWindow::handleDeleteUsers(const QStringList &accounts)
{
    ...
    if (QMessageBox::question(this, windowTitle(),
                              QStringLiteral(u"确定要删除选中的 %1 个用户吗？\n关联的上网记录也会一并移除。").arg(accounts.size())) != QMessageBox::Yes)
    {
        return;
    }
...
void MainWindow::handleReloadUsers()
{
    if (m_usersDirty)
    {
        if (QMessageBox::question(this, windowTitle(), QStringLiteral(u"有未保存的用户信息，确认要放弃修改并重新加载吗？")) != QMessageBox::Yes)
            return;
    }
...
void MainWindow::handleCreateSession()
{
    if (m_users.empty())
    {
        QMessageBox::warning(this, windowTitle(), QStringLiteral(u"请先创建用户后再录入上网记录。"));
        return;
    }
    ...
    {
        QMessageBox::warning(this, windowTitle(), QStringLiteral(u"账号不存在，请在用户管理中新增该账号。"));
        return;
    }
    if (session.end < session.begin)
    {
        QMessageBox::warning(this, windowTitle(), QStringLiteral(u"结束时间不能早于开始时间。"));
        return;
    }
...
void MainWindow::handleEditSession(const Session &session)
{
    ...
    {
        QMessageBox::warning(this, windowTitle(), QStringLiteral(u"账号不存在，请在用户管理中维护该账号。"));
        return;
    }
...
void MainWindow::handleDeleteSessions(const QList<Session> &sessions)
{
    ...
    if (QMessageBox::question(this, windowTitle(),
                              QStringLiteral(u"确定要删除选中的 %1 条上网记录吗？").arg(sessions.size())) != QMessageBox::Yes)
    {
        return;
    }
...
void MainWindow::handleGenerateRandomSessions()
{
    if (m_users.empty())
    {
        QMessageBox::warning(this, windowTitle(), QStringLiteral(u"请先创建至少一个用户。"));
        return;
    }
...
void MainWindow::handleComputeBilling()
{
    ...
    QMessageBox::information(this, windowTitle(), QStringLiteral(u"账单已生成，当前结果尚未导出。"));
}
...
void MainWindow::handleExportBilling()
{
    ...
    {
        QMessageBox::information(this, windowTitle(), QStringLiteral(u"请先生成账单后再导出。"));
        return;
    }
